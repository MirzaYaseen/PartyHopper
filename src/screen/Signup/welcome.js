      ...
      return (
        <View>
          <Text style={styles.content}>
           Find your favorite Parties, connect with colleges around you, meet new friends and experience events
          </Text>
        </View>
      );
    };
    const CustomButton = () => {
      return (
        <View style={{width, padding: 10}}>
          <TouchableOpacity onPress={() => navigation.navigate('devicePermission')}>
      ...
      <>
        ...
        <View style={styles.container}>
          <View style={styles.section}>
            ...
            <ContentArea heading="Welcome To Party Hopper" Content={Content} />
          </View>
          <View>
            <Footer
              topContent="Terms of use"
              Custombutton={CustomButton}
              bottomContent="Privacy Policy "
            />
          </View>
        </View>
      </>
