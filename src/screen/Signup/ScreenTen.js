    ...
    <SafeAreaView style={styles.container}>
      ...
      <Animatable.View animation="fadeInUpBig" style={styles.footer}>
        <ScrollView>
          ...
          <Text style={styles.text_footera}>Are You Sure?</Text>
          ...
          <Text
            ...
            Party Hopper works best with syncing your school and classmates.
            Adding your class schedule greatly improves your Party Hopper
            experience.
          </Text>

          <View style={styles.textPrivate}>
            <Text style={styles.color_textPrivate}>
              It is highly recommended that you add your class schedule before
              proceeding.
            </Text>
          </View>
          <ScreenTenButton />
