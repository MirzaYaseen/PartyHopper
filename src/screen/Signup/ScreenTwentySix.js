...
import ScreenTwentySixButton from '../../constent/Buttons/ScreenTwentySixButton';
const ScreenTwentySix = ({navigation}) => {
  return (
...
export default ScreenTwentySix;
